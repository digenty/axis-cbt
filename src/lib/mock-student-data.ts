      ...
      questions: [
        {
          ...
          text: "What is one benefit of urban gardens?",
          marks: 2,
          options: MCQ_OPTIONS,
        },
        {
          id: "q2",
          type: "multiple-choice",
          text: "How do urban gardens help the environment according to the passage?",
          marks: 2,
          options: MCQ_OPTIONS_2,
        },
        {
          id: "q3",
          type: "multiple-choice",
          text: "What do schools use urban gardens for?",
          marks: 2,
          options: MCQ_OPTIONS,
        },
        {
          id: "q4",
          type: "multiple-choice",
          text: "According to the passage, what makes urban gardens special despite their size?",
          marks: 2,
          options: MCQ_OPTIONS_2,
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          text: "What is one benefit of urban gardens? (Select all that apply)",
          marks: 2,
          options: MCQ_OPTIONS_2,
        },
        {
        ...
        },
        {
          ...
          segments: [
            { type: "text", content: "He is a male " },
            {
              ...
              blankId: "b7b_1",
              inputType: "dropdown",
              choices: ["Select Option", "who", "which", "that"],
            },
          ...
          pairs: [
            {
              id: "p1",
              left: "Choice",
              choices: ["Select", "London", "Paris", "Berlin", "Rome"],
            },
            {
              id: "p2",
              left: "Choice",
        ...
        },
        {
          ...
          segments: [
            { type: "text", content: "The man is a " },
            {
              ...
              blankId: "b12_1",
              inputType: "dropdown",
              choices: ["Select Option", "farmer", "teacher"],
            },
            { type: "text", content: " ✕" },
          ],
        },
