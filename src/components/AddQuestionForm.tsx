    ...
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="flex-1 space-y-5 overflow-y-auto px-6 py-5">
        ...
        {form?.questionType === "TRUE_FALSE" && (
          <Section title="">
            <p className="py-1 text-sm text-gray-400">
              Students will select True or False. You can mark the correct
              answer when marking the assessment.
            </p>
          </Section>
        )}
        ...
        {form?.questionType === "FILL_IN_THE_BLANK" && (
          <Section title="">
            <p className="py-1 text-sm text-gray-400">
              Use the Fill-in-the-Blank form to add blanks and configure each
              gap. This is a simplified view.
            </p>
          </Section>
        )}
