		...
		>
			<div className="space-y-4 px-6 py-4">
				<p className="text-sm text-gray-700">
					Are you sure you want to permanently delete this test? This
				...
				<div className="flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4">
					...
					<p className="text-sm text-amber-800">
						This will remove the test and all associated questions,
						settings, and results linked to it. Students will no longer be
						able to access this test.
					</p>
				</div>
				...
				<label className="flex cursor-pointer items-start gap-3">
					...
					<span className="text-sm text-gray-700">
						I understand that deleting this question is permanent and
						cannot be undone.
					</span>
				</label>
