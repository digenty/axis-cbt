...
export const CreateTestModal = ({
  ...
  const handleSave = async () => {
    if (!validate()) return;
    const payload = buildPayload(form, timeState, branchId, classId, subjectId);
      ...
      <div className="space-y-4 px-5 py-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <SelectField
              value={form.testType}
              onChange={(v) => update("testType", v as AssessmentTestType)}
        ...
        >
          ...
          <div
            className={cn(
              ...
              form.showResultsImmediately ? "bg-blue-600" : "bg-gray-200",
            )}
          >
            <span
              className={cn(
